...
Route::middleware('auth', 'impersonate')->group(function () {
    ...
    Route::get('/completeOrder', [OrderController::class, 'orderSuccess'])->name('completeOrder');
    ...
    Route::get('api/logs', [SettingsController::class, 'apiLogs'])->name('api.logs');
    Route::get('api/logs/search', [SettingsController::class, 'apiLogsSearch'])->name('apilogsearch');
