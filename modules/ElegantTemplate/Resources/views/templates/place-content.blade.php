                            ...
                            <div id='subsection-<?php echo $category->id; ?>' class='box-info'>
                                ...
                                <div class='content'>
                                    @foreach ($category->aitems as $item)
                                        <a href='javascript:;' @if ($item->qty_management==1&&$item->qty>0)  onClick="setCurrentItem({{ $item->id }})" @endif class='item-offer-horizontal'>
                                            <div class='info'>
                                                <h4 class="title">{{ $item->name }} @if ($item->qty_management==1&&$item->qty<1)[{{ __('Out of stock')}}]@endif</h4>
