                ...
                <div id="posRecipt" class="ml-1">
                    ...
                    <div v-if="order&&order.delivery_method!=3" v-cloak class="blockDelivery">
                      ...
                      <p>{{__('Client phone') }}: @{{ 
                        (function(){
                          try {
                            return order.phone.length>3?order.phone:(order&&order.configs.client_phone?order.configs.client_phone:"")
                          } catch(e) {
                            return ""
                          }
                        })()
                      ...
                      <p v-if="order&&order.delivery_method==1" v-cloak>{{__('Client address') }}: @{{ order?order.whatsapp_address:"" }}</p>
                    </div>
