...
return [
    ...
    */
    ...
    'version_installed' => env('SELF_UPDATER_VERSION_INSTALLED', config('version.version')),
    ...
    */
    ...
    'repository_types' => [
        ...
        'http' => [
            'type' => 'http',
            'repository_url' => env('SELF_UPDATER_REPO_URL', 'http://ftupdates.mobidonia.com/v3/').config('version.version').'/',
